...
describe('Cohort Manager', () => {
  ...
  it('should search for a cohort by name', function () {
    const cohorts = new CohortManager([new Cohort('test')])
    const foundCohortName = cohorts.searchName('test')
  ...
  it('should remove a cohort by name', function () {
    const cohort = new CohortManager([{ name: 'test' }])
